...
function module:InitializeMobDrops()
	...
	AddMob(96028,	BN.WRATH_OF_AZSHARA,			Z.EYE_OF_AZSHARA)
	AddMob(100497,	BN.URSOC,				Z.THE_EMERALD_NIGHTMARE)
	AddMob(101403,	BN.SHADE_OF_XAVIUS,			Z.DARKHEART_THICKET)
	AddMob(103769,	BN.XAVIUS,				Z.THE_EMERALD_NIGHTMARE)
	AddMob(106576,	BN.ADVISOR_MELANDRUS,			Z.COURT_OF_STARS)
	AddMob(111000,	BN.ELERETHE_RENFERAL,			Z.THE_EMERALD_NIGHTMARE)
