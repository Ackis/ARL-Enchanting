...
function module:InitializeMobDrops()
	...
	AddMob(15275,	BB["Emperor Vek'nilash"],		Z.AHNQIRAJ_THE_FALLEN_KINGDOM)
	AddMob(15276,	BB["Emperor Vek'lor"],			Z.AHNQIRAJ_THE_FALLEN_KINGDOM)
	AddMob(15687,	BB["Moroes"],				Z.KARAZHAN)
	AddMob(15688,	BB["Terestian Illhoof"],		Z.KARAZHAN)
	AddMob(16472,	L["Phantom Stagehand"],			Z.KARAZHAN)
	AddMob(16524,	BB["Shade of Aran"],			Z.KARAZHAN)
